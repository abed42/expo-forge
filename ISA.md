...
### Quality / ops
- [x] ISC-40: .github/workflows/ci.yml — install, lint, typecheck, test on PR
- [x] ISC-41: Vitest configured with ≥1 real test per app boundary
- [x] ISC-42: eas.json — development/preview/production profiles, appVersionSource remote, autoIncrement
...
- ANDROID SMOKE [x] (Pixel_9_Pro emulator, gradle 578 tasks): app builds, installs, boots; welcome renders correctly (chips, deck, buttons, shadows). One defect found+fixed (3893c4b): Apple  glyph is an Apple private-use codepoint → tofu on Android; replaced with tinted apple.png. Glass fallback paths compile-verified; deeper Android polish remains post-v1 as scoped.
